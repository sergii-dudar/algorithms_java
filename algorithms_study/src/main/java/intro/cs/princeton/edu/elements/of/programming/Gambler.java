...
public class Gambler {
    ...
    public static void main(String[] args) {
        // stake, goal, trials
        args = ArrayUtil.defaultInputIfEmpty(args, "10 20 1000");
        //args = ArrayUtil.defaultInputIfEmpty(args, "50 250 100");
        //args = ArrayUtil.defaultInputIfEmpty(args, "500 2500 100");
        ...
        //System.out.println("(2) Percent of games won = " + 100.0 / (1.0 * trials) * wins);
        System.out.println("Avg # bets           = " + 1.0 * bets / trials);

        System.out.println();
        System.out.println(100.0 * 6.0 / 10.0);
        System.out.println(100.0 / 10.0 * 6.0);

        // System.out.println(100.0 / (6.0 * 10.0));
        // System.out.println(100.0 / 60.0);
    }
